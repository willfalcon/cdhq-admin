(function (factory) {
	...
	function _initAlert() {
	  _initAlert = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
	    var root, optionsRes, options, _options$acf, activate_alert, alert_button, alert_delay, alert_text, cookie_id, alert_color, button, close, alert;
	      ...
	      while (1) {
	        switch (_context.prev = _context.next) {
	          ...
	          case 6:
	            ...
	            console.log(options);
	            _options$acf = options.acf, activate_alert = _options$acf.activate_alert, alert_button = _options$acf.alert_button, alert_delay = _options$acf.alert_delay, alert_text = _options$acf.alert_text, cookie_id = _options$acf.cookie_id, alert_color = _options$acf.alert_color;
	            button = alert_button ? "\n    <a class=\"cdhq-alert__button\" href=\"".concat(alert_button.url, "\" target=\"").concat(alert_button.target, "\" aria-label=\"").concat(alert_button.title, "\">\n      <span class=\"arrow-icon\"></span> \n    </a>\n  ") : "";
